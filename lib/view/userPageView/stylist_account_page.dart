...
// import 'package:memorys/utils/firestore/stylistpost.dart';
...
//   StylistAccountPage({Key? key, this.userInfo, this.isFollwing})
//       : super(key: key);
//   @override
...
//                               print('=============aasds==adsf==========');
//                               print(myPostIds);
//                               return FutureBuilder<List<StylistPost>?>(
//                                   future: StylistPostFirestore(
//                                       myPostIds),
//                                   builder: (context, snapshot) {
//                                     print('=============as==adsf==========');
//                                     if (snapshot.hasData) {
...
//                                         itemCount: snapshot.data!.length,
//                                         itemBuilder: (context, index) {
//                                           UserPost post = snapshot.data![index];
//                                           return Container(
//                                             decoration: BoxDecoration(
//                                                 border: index == 0
//                                                     ? Border(
