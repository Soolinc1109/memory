...
class ShopCreateAccountPage extends StatefulWidget {
  const ShopCreateAccountPage({Key? key}) : super(key: key);

  @override
  _ShopCreateAccountPageState createState() => _ShopCreateAccountPageState();
}

class _ShopCreateAccountPageState extends State<ShopCreateAccountPage> {
