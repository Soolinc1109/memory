...
class AccountDetailsPage extends StatefulWidget {
  ...
  AccountDetailsPage({Key? key, this.isFollwing, required this.account})
      : super(key: key);
  @override
                      ...
                      child: Center(
                        ...
                        child: Column(
                          children: [
                            ...
                            SlideImage(favoriteHairImages: favoriteimage),
                            SizedBox(
                              height: 10,
                            ),
                            Row(
